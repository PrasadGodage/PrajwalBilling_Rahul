...
$newBillNO=generateTempBillNumber($con);
  ...
  <section class="section">
    <div class="section-body">
      ...
      <div class="row">
            ...
            <div class="col-4"> 
                <p><b>BillID : <?php echo $newBillNO;?></b> </p><br>
            </div>
            <div class="col-5 justify-content-end">
                <div class="form-row ">
                    <div class="col-5">
                        <p><b>BillID : <?php echo $newBillNO;?></b> </p>
                    </div>
                    
                    <div class="col-4">
                    Date :  
                        <input type="date" class="form-control form-control-sm" id="BillDate" name="" placeholder="MM/DD/YYYY" />
                    </div>
                </div>      
            </div>
      </div>
                        ...
                        <!-- <form class="form" id="" method="post"> -->
                            ...
                            <div class="col-6 col-md-3 col-lg-3 col-xs-3 input-group-sm ">
                                    <div class="form-group">
                                        ...
                                        <select class="form-control form-control-sm" placeholder="Select Item" id="slscustomer" name="">
                                ...
                                <!-- <div class="col-6 col-md-2 col-lg-2 col-xs-2 input-group-sm ">
                                    <div class="form-group">
                                        ...
                                        <input type="text" class="form-control" placeholder="Enter BillNo."
                                            id="txtTempbillno" value="<?php //echo $newBillNO;?>" name="" readonly>
                                    </div>
                                </div> -->
                                <div class="col-6 col-md-2 col-lg-2 col-xs-2 input-group-sm ">
                                    <div class="form-group">
                                ...
                                <div class="col-6 col-md-2 col-lg-2 col-xs-2 input-group-sm ">
                                    <div class="form-group">
                                        <label class="form-label">Payment Mode</label>
                                            <select class="form-control form-control-sm" id="paymentMtd">
                            ...
                            <div class="row mb">
                                <div class="mb-1 col-6 col-md-3 col-lg-3 col-xs-3 input-group-sm">
                                    ...
                                    <select class="form-control form-control-sm" placeholder="Select Item" id="slsitemname" name="">
                                        <?php echo $itemlist; ?>
                                    </select>
                                    <br>                                 
                                </div>
                                ...
                                <input type="text" class="form-control form-control-sm" name="" id="txtitemdisc">
                                ...
                                <div class="mb-1 col-4 col-md-1 col-lg-1 col-xs-1 input-group-sm">
                                    ...
                                    <input type="text" class="form-control form-control-sm" name="" id="txtqty">
                                </div>
                                <div class="mb-1 col-4 col-md-1 col-lg-1 col-xs-1 input-group-sm">
                                    <label class="form-label" style="text-align:right;">Rate:</label>
                                    <input type="text" class="form-control form-control-sm" name="" id="txtrate">
                                </div>
                              
                                <div class="mb-1 col-4 col-md-1 col-lg-1 col-xs-1 input-group-sm">
                                    <label class="form-label" style="text-align:right;">Disc (%)</label>
                                    <input type="text" class="form-control form-control-sm" name="" id="discper" value="0">
                                </div>
                                <div class="mb-1 col-4 col-md-1 col-lg-1 col-xs-1 input-group-sm">
                                    <label class="form-label" style="text-align:right;">Disc (₹)</label>
                                    <input type="text" class="form-control form-control-sm" name="" id="discamt" value="0">
                                </div>  
                                <div class="mb-1 col-4 col-md-1 col-lg-1 col-xs-1 input-group-sm">
                                    <label class="form-label" style="text-align:right;">Tax</label>
                                    <input type="text" class="form-control form-control-sm" name="" id="taxamount" readonly>
                                </div> 
                                <div class="mb-2 col-4 col-md-2 col-lg-2 col-xs-2 input-group-sm">
                                    <label class="form-label" style="text-align:right;">Total</label>
                                    <input type="text" class="form-control form-control-sm" name="" id="txttotalamt" readonly>
                                </div>
                                <!-- <div class="mb-2 col-4 col-md-2 col-lg-2 col-xs-2 input-group-sm">
                            ...
                            <div class="row mb-3">
                                ...
                                <div class="mb-2 col-4 col-md-2 col-lg-2 col-xs-2 input-group-sm" style="display:none" >                                   
                                ...
                                <div class="mb-1 col-4 col-md-2 col-lg-2 col-xs-2 input-group-sm" style="display:none">
